...
const dataPath = path.join(rootDir, "scripts", "data", "vnjpclub-minna-n4-lessons.json");
const deckSlug = "tu-vung-n4-minna-no-nihongo-26-50";
...
const deck = await Deck.findOneAndUpdate(
  ...
  {
    $set: {
      title: "Từ vựng N4 - Minna no Nihongo 26-50",
      description: "Bộ từ vựng N4 theo Minna no Nihongo bài 26 đến 50, có lựa chọn học từng bài hoặc học toàn bộ.",
      level: "n4",
      ...
      tags: ["N4", "Minna", "Vocabulary", "VNJPCLUB"],
    },
  },
      ...
      updateOne: {
        ...
        update: {
          $set: {
            ...
            tags: ["N4", "Minna", `Bài ${lesson}`, "VNJPCLUB"],
          },
          $addToSet: {
