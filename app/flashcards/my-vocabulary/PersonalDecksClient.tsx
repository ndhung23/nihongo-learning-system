...
type PersonalVocabulary = { _id: string; deckId?: string; sourceDeckTitle?: string; term: string; kana?: string; romaji?: string; meaningVi: string; examples?: Array<{ ja: string; vi?: string }> };
